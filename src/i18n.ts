export const I18N = {
  zh: {
    ...
    tipShowAttrs: "显示属性",
    tipHideAttrs: "隐藏属性",
    tipShowRels: "展开 ID 关联",
    tipHideRels: "简化 ID 关联",
    tipForceOn: "开启持续力导向",
    tipForceOff: "关闭持续力导向",
    tipReadOnly: "切换到只读模式",
    tipEditable: "切换到编辑模式",
    tipBoundaryWidth: "布局宽度 (px，0=不限)",
    tipBoundaryHeight: "布局高度 (px，0=不限)",
    tipShowBoundary: "显示边界矩形",
    tipHideBoundary: "隐藏边界矩形",
    tipHistory: "查看生成历史",
    historyTitle: "生成历史",
    historyEmpty: "暂无历史记录",
...
`,
  ...
  en: {
    ...
    tipShowRels: "Expand ID relationships",
    tipHideRels: "Simplify ID relationships",
    tipForceOn: "Enable continuous force",
    tipForceOff: "Disable continuous force",
    tipReadOnly: "Switch to read-only mode",
    tipEditable: "Switch to edit mode",
    tipBoundaryWidth: "Layout width (px, 0=unlimited)",
    tipBoundaryHeight: "Layout height (px, 0=unlimited)",
    tipShowBoundary: "Show boundary rectangle",
    tipHideBoundary: "Hide boundary rectangle",
